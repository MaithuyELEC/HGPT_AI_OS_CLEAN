...
class ProductionWorker(QThread):
    ...
    def run(self):
        try:
            ...
            # Output ổn định cho bản app đóng gói
            output_root = Path.home() / "Documents" / "LUCID" / "outputs" / "marketing"
            ...
            with redirect_stdout(stream), redirect_stderr(stream):
                ...
                output_dir = production.build_outputs(day, self.topic)

            stream.flush()

            self.output_ready.emit(str(output_dir))
